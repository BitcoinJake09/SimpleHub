...
RUN cp /simplehub/target/SimpleHub.jar /spigot/plugins/SimpleHub.jar
# Add the last version of NoCheatPlus
# ADD https://github.com/BitcoinJake09/SimpleHub/blob/master/Clearlag.jar /spigot/plugins/Clearlag.jar
WORKDIR /spigot
