...
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/simplehub/simplehub/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/simplehub/simplehub/commands/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/simplehub/simplehub/events/*
exit /b 0
